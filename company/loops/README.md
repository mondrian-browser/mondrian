...
see that line, it is almost certainly boot failing, and the app log printed under it says
why. `npm run test:sites` and `npm run test:agent` still need the network by design.
