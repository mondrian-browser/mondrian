...
const HINTS = {
  ...
  tags: /\btags\b|tag-cloud|tag-list|taglist|topic-list|keywords/,
  ...
  pageTools: /page-tools|page-actions|article-tools|article-actions|post-actions/,
  ...
  card: /\bcard(?!__heading)|teaser|promo-card|article-item|post-item|listing-item|result-item|product-item|entry-list|item-card|story-card/,
  ...
  settings: /settings|preferences|appearance|\bunits?\b/,
  ...
  decoration: /decorat|divider|separator|spacer|ornament|icon-only/,
  ...
  metadata: /\bmeta\b|recipe-details|specs?\b|specification|key-facts|quick-facts|properties|attributes|about-item|details-list/,
  transcript: /transcript/,
  correction: /correction|amend|clarification/,
  contentWarning: /content-warning|trigger-warning|sensitive|nsfw/,
  badge: /\bbadge|\bpill\b|\bchip\b|tag-label/,
  ...
  canvas: /\bcanvas\b|whiteboard|drawing-area|board-canvas/,
...
const TEXT = {
  ...
  rating: /\d(\.\d)? ?(out of|\/) ?(5|10)\b|\d+(,\d{3})* ratings?\b|★|☆|\d(\.\d)? stars?\b|\brate (this|it)\b|\bratings?\b/i,
  ...
  cta: /^(get started|start (now|free|your)|try (it|now|free)|sign up (now|free)|download (now|the app)|buy now|shop now|contact sales|book (now|a demo)|request (a )?demo|join (now|us|free)|apply now|donate|support us)\b/i,
  ...
  nutrition: /calories[\s\S]*(fat|carbs?|protein)|nutrition (facts|information)|per serving/i,
  metadata: /(prep|cook|total) time|servings?:|yield:|serves \d|difficulty:|file size|word count|released? (on|date)|runtime:|director:|\bborn\b|\bdied\b|founded|isbn|price:|\bsku\b/i,
  ...
  transcript: /^\[?\d{1,2}:\d{2}(:\d{2})?\]?\s[\s\S]*\n\[?\d{1,2}:\d{2}/,
